...
BEGIN-UNIVERSE
{
  "Not added to universe": [
    ...
    "__atomic_add_fetch_4", "mergeSort", "partition"
  ],
  "Transformations": [
    ...
    "TransformationUpdates": {
      "New Functions": [ "mergeSort", "partition", "main" ],
      "New Externs": [
      ...
      "New Types": [
        ...
        "__mbstate_t", "__anonstruct___mbstate_t_831050739",
...
/* BEGIN FUNCTION-DECL partition LOC=UNKNOWN */
void partition(int *arr , int low , int high ) ;
/* END FUNCTION-DECL partition LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DEF partition LOC=UNKNOWN */
void partition(int *arr , int low , int high ) 
{ 
  int mid ;
...
/* END FUNCTION-DEF partition LOC=UNKNOWN */
