...
/* Generated by Tigress v3.2 (https://tigress.wtf), 14:15:06-2025/03/18 */
...
BEGIN-UNIVERSE
{
  "Not added to universe": [
    ...
    "__atomic_add_fetch_4", "predigits", "postdigits"
  ],
  "Transformations": [
    ...
    "TransformationUpdates": {
      "New Functions": [ "postdigits", "predigits", "main" ],
      "New Global Variables": {
        "i": "FUN: 'i_i$nit'",
        "roman_Number": "None"
      },
...
/* BEGIN FUNCTION-DECL postdigits LOC=UNKNOWN */
void postdigits(char c , int n ) ;
/* END FUNCTION-DECL postdigits LOC=UNKNOWN */
...
/* BEGIN VARIABLE-DEF roman_Number LOC=UNKNOWN */
char roman_Number[1000]  ;
/* END VARIABLE-DEF roman_Number LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL predigits LOC=UNKNOWN */
void predigits(char c1 , char c2 ) ;
/* END FUNCTION-DECL predigits LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DEF predigits LOC=UNKNOWN */
void predigits(char c1 , char c2 ) 
{ 
  int tmp ;
  int tmp___0 ;
...
/* END FUNCTION-DEF predigits LOC=UNKNOWN */
...
{ 
  ...
  i_i$nit_INLINE_i_i$nit: /* CIL Label */ ;
  }
  {
  {
...
/* BEGIN FUNCTION-DEF postdigits LOC=UNKNOWN */
void postdigits(char c , int n ) 
{ 
  int j ;
  int tmp ;
...
/* END FUNCTION-DEF postdigits LOC=UNKNOWN */
