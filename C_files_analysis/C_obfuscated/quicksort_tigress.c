...
BEGIN-UNIVERSE
{
  "Not added to universe": [
    ...
    "__atomic_add_fetch_4", "quicksort"
  ],
  "Transformations": [
...
/* BEGIN FUNCTION-DECL quicksort LOC=UNKNOWN */
void quicksort(int *x , int first , int last ) ;
/* END FUNCTION-DECL quicksort LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DEF quicksort LOC=UNKNOWN */
void quicksort(int *x , int first , int last ) 
{ 
  int pivot ;
  int j ;
...
/* END FUNCTION-DEF quicksort LOC=UNKNOWN */
