...
source_directory = os.path.join(script_directory, "C_files_analysis", "C_obfuscated")
output_directory = os.path.join(script_directory, "C_files_analysis", "native_obfuscated")
