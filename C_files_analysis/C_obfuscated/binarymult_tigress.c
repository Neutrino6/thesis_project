...
/* Generated by Tigress v3.2 (https://tigress.wtf), 14:14:57-2025/03/18 */
...
BEGIN-UNIVERSE
{
  "Not added to universe": [
    ...
    "__atomic_add_fetch_4", "binaryAddition"
  ],
  "Transformations": [
    ...
    "TransformationUpdates": {
      "New Functions": [ "binaryAddition", "main" ],
      "New Externs": [
      ...
      "New Types": [
        ...
        "__mbstate_t", "__anonstruct___mbstate_t_67544462",
...
/* BEGIN FUNCTION-DECL binaryAddition LOC=UNKNOWN */
int binaryAddition(int binary1 , int binary2 ) ;
/* END FUNCTION-DECL binaryAddition LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DEF binaryAddition LOC=UNKNOWN */
int binaryAddition(int binary1 , int binary2 ) 
{ 
  int i ;
  int remainder ;
...
/* END FUNCTION-DEF binaryAddition LOC=UNKNOWN */
