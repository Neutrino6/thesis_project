...
BEGIN-UNIVERSE
{
  "Not added to universe": [
    ...
    "__atomic_add_fetch_4", "stringConcat"
  ],
  "Transformations": [
    ...
    "TransformationUpdates": {
      "New Functions": [ "stringConcat", "main" ],
      "New Externs": [
...
/* BEGIN FUNCTION-DECL stringConcat LOC=UNKNOWN */
void stringConcat(char *str1 , char *str2 ) ;
/* END FUNCTION-DECL stringConcat LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DEF stringConcat LOC=UNKNOWN */
void stringConcat(char *str1 , char *str2 ) 
{ 
  int i ;
  int j ;
...
/* END FUNCTION-DEF stringConcat LOC=UNKNOWN */
